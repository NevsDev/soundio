...
type
  SoundIoChannelLayout* {.importc: "SoundIoChannelLayout", bycopy.} = object
    name* {.importc: "name".}: cstring
    channel_count* {.importc: "channel_count".}: cint
    channels* {.importc: "channels".}: array[SOUNDIO_MAX_CHANNELS, SoundIoChannelId]


## / The size of this struct is OK to use.

type
  SoundIoSampleRateRange* {.importc: "SoundIoSampleRateRange", bycopy.} = object
...
type
  SoundIoChannelArea* {.importc: "SoundIoChannelArea", bycopy.} = object
    `ptr`* {.importc: "ptr".}: cstring ## / Base address of buffer.
    ## / How many bytes it takes to get from the beginning of one sample to
    ## / the beginning of the next sample.
    step* {.importc: "step".}: cint


## / The size of this struct is not part of the API or ABI.

type
  SoundIo* {.importc: "SoundIo", bycopy.} = object
    userdata* {.importc: "userdata".}: pointer ## / Optional. Put whatever you want here. Defaults to NULL.
    ...
    on_devices_change* {.importc: "on_devices_change".}: proc (a1: ptr SoundIo) {.cdecl.} ##
                                                                                  ## /
                                                                                  ## Optional
                                                                                  ## callback.
                                                                                  ## Called
                                                                                  ...
                                                                                  ## /
                                                                                  ## information
    on_backend_disconnect* {.importc: "on_backend_disconnect".}: proc (
        a1: ptr SoundIo; err: cint) {.cdecl.} ## / Optional callback. Called from an unknown thread that you should not use
    ...
    on_events_signal* {.importc: "on_events_signal".}: proc (a1: ptr SoundIo) {.cdecl.} ##
                                                                                ## /
                                                                                ## Read-only.
                                                                                ## After
                                                                                ## calling
                                                                                ...
                                                                                ## currently
                                                                                ## connected.
    current_backend* {.importc: "current_backend".}: SoundIoBackend ## / Optional: Application name.
                                                                ## / PulseAudio uses this for "application name".
                                                                ## / JACK uses this for `client_name`.
                                                                ## / Must not contain a colon (":").
    app_name* {.importc: "app_name".}: cstring ## / Optional: Real time priority warning.
    ...
    emit_rtprio_warning* {.importc: "emit_rtprio_warning".}: proc () {.cdecl.} ## /
                                                                         ## Optional: JACK info
                                                                         ## callback.
                                                                         ## / By
                                                                         ## default,
                                                                         ## libsoundio sets this to an empty
                                                                         ## function in order to
                                                                         ## / silence stdio
                                                                         ## messages from JACK. You may
                                                                         ## override the
                                                                         ## behavior by
                                                                         ## / setting this to `NULL` or
                                                                         ## providing your own
                                                                         ## function. This is
                                                                         ## /
                                                                         ...
                                                                         ## /
                                                                         ## succeeds.
    jack_info_callback* {.importc: "jack_info_callback".}: proc (msg: cstring) {.cdecl.} ##
                                                                                  ## /
                                                                                  ## Optional:
                                                                                  ## JACK
                                                                                  ## error
    ...
    jack_error_callback* {.importc: "jack_error_callback".}: proc (msg: cstring) {.
        cdecl.}
...
type
  SoundIoDevice* {.importc: "SoundIoDevice", bycopy.} = object
    soundio* {.importc: "soundio".}: ptr SoundIo ## / Read-only. Set automatically.
    ...
    ## / SoundIoDevice::aim.
    id* {.importc: "id".}: cstring ## / User-friendly UTF-8 encoded text to describe the device.
    name* {.importc: "name".}: cstring ## / Tells whether this device is an input device or an output device.
    aim* {.importc: "aim".}: SoundIoDeviceAim ## / Channel layouts are handled similarly to SoundIoDevice::formats.
    ...
    layouts* {.importc: "layouts".}: ptr SoundIoChannelLayout
    layout_count* {.importc: "layout_count".}: cint ## / See SoundIoDevice::current_format
    current_layout* {.importc: "current_layout".}: SoundIoChannelLayout ## / List of formats this device supports. See also
                                                                    ## /
                                                                    ## SoundIoDevice::current_format.
    formats* {.importc: "formats".}: ptr SoundIoFormat ## / How many formats are available in SoundIoDevice::formats.
    format_count* {.importc: "format_count".}: cint ## / A device is either a raw device or it is a virtual device that is
    ...
    current_format* {.importc: "current_format".}: SoundIoFormat ## / Sample rate is the number of frames per second.
                                                             ## / Sample rate is handled very similar to
                                                             ## SoundIoDevice::formats.
                                                             ## / If sample rate information is missing due to a probe error, the field
                                                             ## / will be set to NULL.
                                                             ## / Devices which have
                                                             ## SoundIoDevice::probe_error set to #SoundIoErrorNone are
                                                             ## / guaranteed to have at least 1 sample rate available.
    sample_rates* {.importc: "sample_rates".}: ptr SoundIoSampleRateRange ## / How many sample rate ranges are available in
                                                                     ## /
                                                                     ## SoundIoDevice::sample_rates. 0 if sample rate information is missing
                                                                     ## / due to a probe error.
    sample_rate_count* {.importc: "sample_rate_count".}: cint ## / See
                                                          ## SoundIoDevice::current_format
                                                          ## / 0 if sample rate information is missing due to a probe error.
    sample_rate_current* {.importc: "sample_rate_current".}: cint ## / Software latency minimum in seconds. If this value is unknown or
                                                              ## / irrelevant, it is set to 0.0.
                                                              ## / For PulseAudio and WASAPI this value is unknown until you open a
                                                              ## / stream.
    software_latency_min* {.importc: "software_latency_min".}: cdouble ## / Software latency maximum in seconds. If this value is unknown or
                                                                   ## / irrelevant, it is set to 0.0.
                                                                   ## / For PulseAudio and WASAPI this value is unknown until you open a
                                                                   ## / stream.
    software_latency_max* {.importc: "software_latency_max".}: cdouble ## / Software latency in seconds. If this value is unknown or
                                                                   ## / irrelevant, it is set to 0.0.
                                                                   ## / For PulseAudio and WASAPI this value is unknown until you open a
                                                                   ## / stream.
                                                                   ## / See
                                                                   ## SoundIoDevice::current_format
    software_latency_current* {.importc: "software_latency_current".}: cdouble ## / Raw means that you are
                                                                           ## directly
                                                                           ## opening the
                                                                           ## hardware
                                                                           ## device and not
                                                                           ## / going
                                                                           ## through a proxy such as dmix,
                                                                           ## PulseAudio, or JACK. When you open a
                                                                           ## / raw
                                                                           ## device, other
                                                                           ## applications on the
                                                                           ## computer are not able to
                                                                           ## /
                                                                           ## simultaneously
                                                                           ## access the
                                                                           ## device. Raw
                                                                           ...
                                                                           ## automatic
                                                                           ## /
                                                                           ## resampling and thus tend to have fewer
                                                                           ## formats
                                                                           ## available.
    is_raw* {.importc: "is_raw".}: bool ## / Devices are reference counted. See ::soundio_device_ref and
                                    ## / ::soundio_device_unref.
    ref_count* {.importc: "ref_count".}: cint ## / This is set to a SoundIoError representing the result of the device
                                          ...
                                          ## / * #SoundIoErrorOpeningDevice
                                          ## / * #SoundIoErrorNoMem
    probe_error* {.importc: "probe_error".}: cint


## / The size of this struct is not part of the API or ABI.

type
  SoundIoOutStream* {.importc: "SoundIoOutStream", bycopy.} = object
    device* {.importc: "device".}: ptr SoundIoDevice ## / Populated automatically when you call ::soundio_outstream_create.
    ## / Defaults to #SoundIoFormatFloat32NE, followed by the first one
    ## / supported.
    format* {.importc: "format".}: SoundIoFormat ## / Sample rate is the number of frames per second.
                                             ## / Defaults to 48000 (and then clamped into range).
    sample_rate* {.importc: "sample_rate".}: cint ## / Defaults to Stereo, if available, followed by the first layout
                                              ## / supported.
    layout* {.importc: "layout".}: SoundIoChannelLayout ## / Ignoring hardware latency, this is the number of seconds it takes for
    ...
    software_latency* {.importc: "software_latency".}: cdouble ## / Core Audio and WASAPI only: current output Audio Unit volume. Float, 0.0-1.0.
    volume* {.importc: "volume".}: cfloat ## / Defaults to NULL. Put whatever you want here.
    userdata* {.importc: "userdata".}: pointer ## / In this callback, you call ::soundio_outstream_begin_write and
    ...
    write_callback* {.importc: "write_callback".}: proc (a1: ptr SoundIoOutStream;
        frame_count_min: cint; frame_count_max: cint) {.cdecl.} ## / This optional callback happens when the sound device runs out of
    ...
    underflow_callback* {.importc: "underflow_callback".}: proc (
        a1: ptr SoundIoOutStream) {.cdecl.} ## / Optional callback. `err` is always SoundIoErrorStreaming.
    ...
    error_callback* {.importc: "error_callback".}: proc (a1: ptr SoundIoOutStream;
        err: cint) {.cdecl.} ## / Optional: Name of the stream. Defaults to "SoundIoOutStream"
                          ...
                          ## / Must not contain a colon (":").
    name* {.importc: "name".}: cstring ## / Optional: Hint that this output stream is nonterminal. This is used by
                                   ## / JACK and it means that the output stream data originates from an input
                                   ## / stream. Defaults to `false`.
    non_terminal_hint* {.importc: "non_terminal_hint".}: bool ## / computed automatically when you call
                                                          ## ::soundio_outstream_open
    bytes_per_frame* {.importc: "bytes_per_frame".}: cint ## / computed automatically when you call ::soundio_outstream_open
    bytes_per_sample* {.importc: "bytes_per_sample".}: cint ## / If setting the channel layout fails for some reason, this field is set
                                                        ## / to an error code. Possible error codes are:
                                                        ## / *
                                                        ## #SoundIoErrorIncompatibleDevice
    layout_error* {.importc: "layout_error".}: cint


## / The size of this struct is not part of the API or ABI.

type
  SoundIoInStream* {.importc: "SoundIoInStream", bycopy.} = object
    device* {.importc: "device".}: ptr SoundIoDevice ## / Populated automatically when you call ::soundio_outstream_create.
    ## / Defaults to #SoundIoFormatFloat32NE, followed by the first one
    ## / supported.
    format* {.importc: "format".}: SoundIoFormat ## / Sample rate is the number of frames per second.
    ...
    sample_rate* {.importc: "sample_rate".}: cint ## / Defaults to Stereo, if available, followed by the first layout
                                              ## / supported.
    layout* {.importc: "layout".}: SoundIoChannelLayout ## / Ignoring hardware latency, this is the number of seconds it takes for a
    ...
    software_latency* {.importc: "software_latency".}: cdouble ## / Defaults to NULL. Put whatever you want here.
    userdata* {.importc: "userdata".}: pointer ## / In this function call ::soundio_instream_begin_read and
                                           ...
                                           ## / malloc, free, printf, pthread_mutex_lock, sleep, wait, poll, select,
                                           ## / pthread_join, pthread_cond_wait, etc.
    read_callback* {.importc: "read_callback".}: proc (a1: ptr SoundIoInStream;
        frame_count_min: cint; frame_count_max: cint) {.cdecl.} ## / This optional callback happens when the sound device buffer is full,
                                                           ## / yet there is more captured audio to put in it.
                                                           ## / This is never fired for PulseAudio.
                                                           ## / This is called from the
                                                           ## SoundIoInStream::read_callback thread context.
    overflow_callback* {.importc: "overflow_callback".}: proc (
        a1: ptr SoundIoInStream) {.cdecl.} ## / Optional callback. `err` is always SoundIoErrorStreaming.
                                       ## / SoundIoErrorStreaming is an unrecoverable error. The stream is in an
                                       ## / invalid state and must be destroyed.
                                       ## / If you do not supply `error_callback`, the default callback will print
                                       ## / a message to stderr and then abort().
                                       ## / This is called from the SoundIoInStream::read_callback thread context.
    error_callback* {.importc: "error_callback".}: proc (a1: ptr SoundIoInStream;
        err: cint) {.cdecl.} ## / Optional: Name of the stream. Defaults to "SoundIoInStream";
                          ## / PulseAudio uses this for the stream name.
                          ## / JACK uses this for the client name of the client that connects when you
                          ## / open the stream.
                          ## / WASAPI uses this for the session display name.
                          ## / Must not contain a colon (":").
    name* {.importc: "name".}: cstring ## / Optional: Hint that this input stream is nonterminal. This is used by
    ...
    bytes_per_frame* {.importc: "bytes_per_frame".}: cint ## / computed automatically when you call ::soundio_instream_open
    bytes_per_sample* {.importc: "bytes_per_sample".}: cint ## / If setting the channel layout fails for some reason, this field is set
                                                        ## / to an error code. Possible error codes are:
                                                        ## #SoundIoErrorIncompatibleDevice
    layout_error* {.importc: "layout_error".}: cint
...
proc soundio_connect_backend*(soundio: ptr SoundIo; backend: SoundIoBackend): cint {.
    cdecl, importc: "soundio_connect_backend".}
proc soundio_disconnect*(soundio: ptr SoundIo) {.cdecl,
...
proc soundio_backend_name*(backend: SoundIoBackend): cstring {.cdecl,
    importc: "soundio_backend_name".}
## / Returns the number of available backends.

proc soundio_backend_count*(soundio: ptr SoundIo): cint {.cdecl,
    importc: "soundio_backend_count".}
## / get the available backend at the specified index
## / (0 <= index < ::soundio_backend_count)

proc soundio_get_backend*(soundio: ptr SoundIo; index: cint): SoundIoBackend {.cdecl,
    importc: "soundio_get_backend".}
## / Returns whether libsoundio was compiled with backend.

proc soundio_have_backend*(backend: SoundIoBackend): bool {.cdecl,
...
proc soundio_flush_events*(soundio: ptr SoundIo) {.cdecl,
...
proc soundio_wait_events*(soundio: ptr SoundIo) {.cdecl,
...
proc soundio_force_device_scan*(soundio: ptr SoundIo) {.cdecl,
...
proc soundio_channel_layout_equal*(a: ptr SoundIoChannelLayout;
                                  b: ptr SoundIoChannelLayout): bool {.cdecl,
    importc: "soundio_channel_layout_equal".}
proc soundio_get_channel_name*(id: SoundIoChannelId): cstring {.cdecl,
...
proc soundio_parse_channel_id*(str: cstring; str_len: cint): SoundIoChannelId {.cdecl,
    importc: "soundio_parse_channel_id".}
## / Returns the number of builtin channel layouts.

proc soundio_channel_layout_builtin_count*(): cint {.cdecl,
...
proc soundio_channel_layout_find_channel*(layout: ptr SoundIoChannelLayout;
    channel: SoundIoChannelId): cint {.cdecl, importc: "soundio_channel_layout_find_channel".}
...
proc soundio_best_matching_channel_layout*(
    ...
    available_layouts: ptr SoundIoChannelLayout; available_layout_count: cint): ptr SoundIoChannelLayout {.
    cdecl, importc: "soundio_best_matching_channel_layout".}
## / Sorts by channel count, descending.

proc soundio_sort_channel_layouts*(layouts: ptr SoundIoChannelLayout;
                                  layout_count: cint) {.cdecl,
    importc: "soundio_sort_channel_layouts".}
##  Sample Formats
## / Returns -1 on invalid format.

proc soundio_get_bytes_per_sample*(format: SoundIoFormat): cint {.cdecl,
    importc: "soundio_get_bytes_per_sample".}
## / A frame is one sample per channel.

proc soundio_get_bytes_per_frame*(format: SoundIoFormat; channel_count: cint): cint {.
    inline, cdecl.} =
  return soundio_get_bytes_per_sample(format) * channel_count

## / Sample rate is the number of frames per second.

proc soundio_get_bytes_per_second*(format: SoundIoFormat; channel_count: cint;
                                  sample_rate: cint): cint {.inline, cdecl.} =
  return soundio_get_bytes_per_frame(format, channel_count) * sample_rate

## / Returns string representation of `format`.

proc soundio_format_string*(format: SoundIoFormat): cstring {.cdecl,
...
proc soundio_input_device_count*(soundio: ptr SoundIo): cint {.cdecl,
    importc: "soundio_input_device_count".}
## / Get the number of output devices.
## / Returns -1 if you never called ::soundio_flush_events.

proc soundio_output_device_count*(soundio: ptr SoundIo): cint {.cdecl,
    importc: "soundio_output_device_count".}
...
proc soundio_default_input_device_index*(soundio: ptr SoundIo): cint {.cdecl,
    importc: "soundio_default_input_device_index".}
## / returns the index of the default output device
## / returns -1 if there are no devices or if you never called
## / ::soundio_flush_events.

proc soundio_default_output_device_index*(soundio: ptr SoundIo): cint {.cdecl,
    importc: "soundio_default_output_device_index".}
## / Add 1 to the reference count of `device`.

proc soundio_device_ref*(device: ptr SoundIoDevice) {.cdecl,
    importc: "soundio_device_ref".}
## / Remove 1 to the reference count of `device`. Clean up if it was the last
## / reference.

proc soundio_device_unref*(device: ptr SoundIoDevice) {.cdecl,
...
proc soundio_device_equal*(a: ptr SoundIoDevice; b: ptr SoundIoDevice): bool {.cdecl,
    importc: "soundio_device_equal".}
## / Sorts channel layouts by channel count, descending.

proc soundio_device_sort_channel_layouts*(device: ptr SoundIoDevice) {.cdecl,
    importc: "soundio_device_sort_channel_layouts".}
## / Convenience function. Returns whether `format` is included in the device's
## / supported formats.

proc soundio_device_supports_format*(device: ptr SoundIoDevice;
                                    format: SoundIoFormat): bool {.cdecl,
    importc: "soundio_device_supports_format".}
## / Convenience function. Returns whether `layout` is included in the device's
## / supported channel layouts.

proc soundio_device_supports_layout*(device: ptr SoundIoDevice;
                                    layout: ptr SoundIoChannelLayout): bool {.cdecl,
    importc: "soundio_device_supports_layout".}
## / Convenience function. Returns whether `sample_rate` is included in the
## / device's supported sample rates.

proc soundio_device_supports_sample_rate*(device: ptr SoundIoDevice;
...
proc soundio_device_nearest_sample_rate*(device: ptr SoundIoDevice;
...
proc soundio_outstream_destroy*(outstream: ptr SoundIoOutStream) {.cdecl,
    importc: "soundio_outstream_destroy".}
...
proc soundio_outstream_open*(outstream: ptr SoundIoOutStream): cint {.cdecl,
    importc: "soundio_outstream_open".}
...
proc soundio_outstream_start*(outstream: ptr SoundIoOutStream): cint {.cdecl,
    importc: "soundio_outstream_start".}
...
proc soundio_outstream_begin_write*(outstream: ptr SoundIoOutStream;
...
proc soundio_outstream_end_write*(outstream: ptr SoundIoOutStream): cint {.cdecl,
    importc: "soundio_outstream_end_write".}
...
proc soundio_outstream_clear_buffer*(outstream: ptr SoundIoOutStream): cint {.cdecl,
    importc: "soundio_outstream_clear_buffer".}
...
proc soundio_outstream_get_latency*(outstream: ptr SoundIoOutStream;
...
proc soundio_instream_create*(device: ptr SoundIoDevice): ptr SoundIoInStream {.cdecl,
    importc: "soundio_instream_create".}
## / You may not call this function from SoundIoInStream::read_callback.

proc soundio_instream_destroy*(instream: ptr SoundIoInStream) {.cdecl,
    importc: "soundio_instream_destroy".}
...
proc soundio_instream_open*(instream: ptr SoundIoInStream): cint {.cdecl,
    importc: "soundio_instream_open".}
...
proc soundio_instream_start*(instream: ptr SoundIoInStream): cint {.cdecl,
    importc: "soundio_instream_start".}
...
proc soundio_instream_begin_read*(instream: ptr SoundIoInStream;
                                 areas: ptr ptr SoundIoChannelArea;
                                 frame_count: ptr cint): cint {.cdecl,
...
proc soundio_instream_end_read*(instream: ptr SoundIoInStream): cint {.cdecl,
    importc: "soundio_instream_end_read".}
...
proc soundio_instream_pause*(instream: ptr SoundIoInStream; pause: bool): cint {.cdecl,
...
proc soundio_instream_get_latency*(instream: ptr SoundIoInStream;
                                  out_latency: ptr cdouble): cint {.cdecl,
    importc: "soundio_instream_get_latency".}
type
  SoundIoRingBuffer* {.importc: "SoundIoRingBuffer", bycopy.} = object
...
proc soundio_ring_buffer_destroy*(ring_buffer: ptr SoundIoRingBuffer) {.cdecl,
    importc: "soundio_ring_buffer_destroy".}
...
proc soundio_ring_buffer_capacity*(ring_buffer: ptr SoundIoRingBuffer): cint {.cdecl,
    importc: "soundio_ring_buffer_capacity".}
## / Do not write more than capacity.

proc soundio_ring_buffer_write_ptr*(ring_buffer: ptr SoundIoRingBuffer): cstring {.
    cdecl, importc: "soundio_ring_buffer_write_ptr".}
## / `count` in bytes.

proc soundio_ring_buffer_advance_write_ptr*(ring_buffer: ptr SoundIoRingBuffer;
    count: cint) {.cdecl, importc: "soundio_ring_buffer_advance_write_ptr".}
## / Do not read more than capacity.

proc soundio_ring_buffer_read_ptr*(ring_buffer: ptr SoundIoRingBuffer): cstring {.
    cdecl, importc: "soundio_ring_buffer_read_ptr".}
## / `count` in bytes.

proc soundio_ring_buffer_advance_read_ptr*(ring_buffer: ptr SoundIoRingBuffer;
    count: cint) {.cdecl, importc: "soundio_ring_buffer_advance_read_ptr".}
...
proc soundio_ring_buffer_clear*(ring_buffer: ptr SoundIoRingBuffer) {.cdecl,
    importc: "soundio_ring_buffer_clear".}